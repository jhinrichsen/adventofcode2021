...
func NewDay12(lines []string) (map[string][]string, error) {
...
func Day12(connections map[string][]string, part1 bool) int {
	if part1 {
...
func countPaths(connections map[string][]string, start, end string, canVisitTwice bool) int {
